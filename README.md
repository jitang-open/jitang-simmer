...
- **🤖 AI Token Statistics**：请求级统计 Codex、ZCode 和 DeepSeek Harness；展示输入、输出、缓存读取/写入、推理、总 Token、年度 P95 点阵、来源/模型排行；来源/provider 使用统一下拉、模型支持多选，日/周/月日期范围独立于顶栏；已经上传的历史不随本地日志、工具或扫描路径消失
